function server_Hill3_mGAP
%This function is the same as server_Hill_mGAP except Hill coefficient=3
...
name={'server_Hill3_tG_0dot01_mGAP.mat','server_Hill3_tG_1_mGAP.mat','server_Hill3_tG_10_mGAP.mat'}; s=0;
parpool(12);
        ...
        parfor j=1:length(kmG_all)
            ...
            for k=1:length(mGAP_all)
                ...
                Y=resp_curve(C0,S_all,kon_R,koff_R,kon_mGEF,koff_mGEF,kon_mGAP,koff_mGAP,kon_mG,koff_mG,...
                                            kon_tGEF,koff_tGEF,tGAP_ss,kon_tG,koff_tG,Tot,@fun_Hill,3,'kon_mGAP',kon_mGAP); 
                r_range =Y(:,1);
                mg_range=Y(:,4); 
                tg_range=Y(:,6); 
