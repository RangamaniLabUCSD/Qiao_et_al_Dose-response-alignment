...
function dC=fun_Hill(t,C,S,kon_R,koff_R,kon_mGEF,koff_mGEF,kon_mGAP,koff_mGAP,kon_mG,koff_mG,...
            kon_tGEF,koff_tGEF,tGAP_ss,kon_tG,koff_tG,Tot,n)
% Description: This function is the same as fun_mass_action except the kinetic forms 
